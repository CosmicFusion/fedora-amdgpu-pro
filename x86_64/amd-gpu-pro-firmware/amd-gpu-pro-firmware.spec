...
Source0:  http://repo.radeon.com/amdgpu/%{repo}/amdgpu/ubuntu/pool/main/a/amdgpu-dkms/amdgpu-dkms-firmware_%{firmware_rev}.%{firmware_maj}-%{firmware_min}.20.04_all.deb
